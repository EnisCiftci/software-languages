...
/**
 * This is the item provider adapter for a {@link Manufacturing.WorkPiece} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkPieceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ManufacturingPackage.Literals.WORK_PIECE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkPiece_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkPiece_id_feature", "_UI_WorkPiece_type"),
				 ManufacturingPackage.Literals.WORK_PIECE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ManufacturingPackage.Literals.WORK_PIECE__TYPE);
		}
	...
	public String getText(Object object) {
		WorkPiece workPiece = (WorkPiece)object;
		return getString("_UI_WorkPiece_type") + " " + workPiece.getId();
	}
